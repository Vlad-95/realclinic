...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./utils */ "./resources/js/modules/utils.js");
...
var modal = function modal() {
  ...
  modalTriggers.forEach(function (elem) {
    elem.addEventListener('click', function () {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_14__.fadeIn)(document.querySelector(".modal[data-modal=\"".concat(target, "\"]")));
    });
  }); //закрытие модалки

  var closeModalBtns = document.querySelectorAll('.js-modal-close');
  closeModalBtns.forEach(function (elem) {
    elem.addEventListener('click', function () {
      var modal = elem.closest('.modal');
      document.querySelector('body').classList.remove('no-scroll');
      (0,_utils__WEBPACK_IMPORTED_MODULE_14__.fadeOut)(modal);
    });
  }); //Клик по табам в модалке

  var tabs = document.querySelectorAll('.modal .tabs__item');
  tabs.forEach(function (elem) {
    elem.addEventListener('click', function () {
      var allElems = elem.parentElement.children;

      _toConsumableArray(allElems).forEach(function (item) {
